...
const Settings = {
  ...
  ACCOUNT_FIELDS: [
    { id: "id", title: "ID" },
    { id: "title", title: "Название" },
    { id: "instrument", title: "Инструмент" },
    { id: "type", title: "Тип" },
  ...
  //═══════════════════════════════════════════════════════════════════════════
  // НАСТРОЙКИ ЭКСПОРТА
  // Цвета для различных состояний строк при экспорте
  //═══════════════════════════════════════════════════════════════════════════
  EXPORT: {
    COLORS: {
      NEW: "#d9ead3",      // Зеленый - для новых записей
      WAS_NEW: "#e6ffe1",  // Нефритовый - для бывших новых записей
  ...
  //═══════════════════════════════════════════════════════════════════════════
  IMPORT: {
    BATCH_SIZE: 100,       // Размер пакета для импорта
    PROGRESS_INTERVAL: 100,// Интервал обновления прогресса
    UPDATE_COLUMNS_LIST: [ // Список колонок для обновления
