...
Скрипт Main добавляет в Google Таблицы меню Zen Money, которое содержит следующие кнопки, в зависимости от установленных вами скриптов:
* Кнопка Full Sync: последовательно вызывает скрипты синхронизации и экспорта транзакций, словарей, категорий, счетов и мест на отдельные листы.
